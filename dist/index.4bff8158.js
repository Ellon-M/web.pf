...
})({"bWoui":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0084c5bf4bff8158";
"use strict";
...
},{}],"iXA79":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
const form_1 = require("2abc2419ab083c96");
new form_1.Form();

},{"2abc2419ab083c96":"g8Urv"}],"g8Urv":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Form = void 0;
const gsap_1 = require("1fbc4ec156aff132");
class Form {
    constructor(){
        this.animIn = ()=>{
    ...
    initEvents() {
        ...
        this.nextBtnEmail.addEventListener("click", ()=>{
            ...
            if (emailValue === "" || !emailRegex.test(emailValue)) alert("Invalid email address. Please enter a valid email.");
            else this.toDetails();
        });
    ...
    toEmail() {
        ...
        gsap_1.gsap.to(this.formBodyName, {
            ...
            onComplete: ()=>{
                ...
                gsap_1.gsap.fromTo(this.formEmail, {
                    opacity: 0,
                    y: -150
                }, {
                    opacity: 1,
    ...
    toDetails() {
        ...
        gsap_1.gsap.to(this.formBodyEmail, {
            ...
            onComplete: ()=>{
                ...
                gsap_1.gsap.fromTo(this.formBodyDetails, {
                    opacity: 0,
                    y: -150
                }, {
                    opacity: 1,
    ...
    toName() {
        gsap_1.gsap.to(this.formBodyEmail, {
            ...
            onComplete: ()=>{
                ...
                this.formEmail.classList.add("hidden");
                this.formName.classList.remove("hidden");
                gsap_1.gsap.fromTo(this.formBodyName, {
                    opacity: 0,
                    y: -150
                }, {
                    opacity: 1,
    ...
    onSubmit() {
        gsap_1.gsap.to(this.formBodyDetails, {
            ...
            onComplete: ()=>{
                ...
                gsap_1.gsap.fromTo(this.postMessage, {
                    opacity: 0,
                    y: -150
                }, {
                    opacity: 1,
...
},{"1fbc4ec156aff132":"fPSuC"}]},["bWoui","iXA79"], "iXA79", "parcelRequire6e9e")

//# sourceMappingURL=index.4bff8158.js.map
